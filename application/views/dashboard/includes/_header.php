...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url(); ?>assets/admin/css/plugins-1.9.css">
    ...
    <link rel="stylesheet" href="<?= base_url(); ?>assets/admin/css/main-1.9.css">
    <link rel="stylesheet" href="<?= base_url(); ?>assets/admin/css/dashboard-1.9.css">
    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            <div class="sidebar-scrollbar">
                <div class="logo" >
                    <a href="<?= dashboard_url(); ?>"><img style="width:58px!important;" src="<?php echo get_logo($this->general_settings); ?>" alt="logo"></a>
                </div>
